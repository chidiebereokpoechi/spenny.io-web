...
type ButtonProps = HTMLMotionProps<'button'> & ComponentPropsWithRef<'button'>

export interface CustomButtonSelectInputProps<T> {
    name: string
    className?: string
...
export const CustomButtonSelectInput = <T,>({
    name,
    className,
    label,
    errors,
    ...
    options: optionTypes,
    accessor,
}: React.PropsWithChildren<CustomButtonSelectInputProps<T>>) => {
